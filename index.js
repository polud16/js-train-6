...
function copyObject(obj) {
  ...
  return { ...obj }; // Повертаємо новий об'єкт
}
...
function changeRole(array, newRole) {
  ...
  console.log(userList); // Виводимо об'єкт на консоль
}
...
function compareObjects(obj1, obj2) {
  console.log("Objects Before Assignment:");
  console.log(obj1 === obj2); // Перевіряємо, чи об'єкти однакові

  obj2 = obj1; // Присвоюємо obj2 значення об'єкту obj1

  console.log("Objects After Assignment:");
...
Array.prototype.customProperty = "myProperty"; // Створюємо функцію, яка буде додавати нову властивість до масиву
function addProperty(array) {
  array.customProperty = "myProperty";
  return array; // Додаємо нову властивість customProperty до прототипу Array зі значенням myProperty
